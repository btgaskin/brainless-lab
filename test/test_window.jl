...
@testset "substeps knob reaches simulate and changes behavior" begin
    s1 = BrainlessLabTestUtils.diagnostic_simulate(:wall; node=:falandays, seed=7, ticks=120, node_kwargs=(substeps=1,))
    s5 = BrainlessLabTestUtils.diagnostic_simulate(:wall; node=:falandays, seed=7, ticks=120, node_kwargs=(substeps=5,))
