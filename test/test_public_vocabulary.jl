...
@testset "package names have explicit core and supported-public tiers" begin
    expected_exports = Set((
        ...
        :BenchmarkPlan,
        :ModelProfileSpec,
        :BenchmarkTaskProtocol,
        :BenchmarkEntrySpec,
        :BenchmarkSpec,
        :DIRECT_CONTROL_FALANDAYS_PROFILE,
        :DIRECT_CONTROL_SORN_PROFILE,
        :DIRECT_CONTROL_BENCHMARK,
...
@testset "core workflows are complete after using BrainlessLab" begin
    workflows = (
        ...
        create_benchmark=(
            :CompositionSpec, :InterfaceSpec, :ModelProfileSpec, :BenchmarkSpec,
            :composition_spec, :resolve_composition,
