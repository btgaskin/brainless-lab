...
Versions 1 and 2 remain readable. The current writer emits version 3. Version 2 introduced
the public evolution schema; version 3 adds scheduled target interventions, registered
analysis options, compute strides, and aggregate analysis-series tables.
...
New plans should declare `format_version = 3`. The checked-in `plans/examples/*.toml`
