...
A ready-to-copy skeleton lives in `examples/templates/new_project/`.

<p class="bl-source">Source: <code>src/core/Registry.jl</code>, <code>docs/contracts.md</code>, <code>examples/templates/new_project/</code>.</p>
