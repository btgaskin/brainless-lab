...
description: Inspect the registered Falandays and SORN nodes and the three benchmark task contracts.
---
...
Benchmark version 1 does not use those task-specific presets. It declares one fixed
