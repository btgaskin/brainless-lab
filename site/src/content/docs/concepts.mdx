...
- **Body** — the sensorimotor morphology: it turns a percept into receptor currents and effector outputs into actuation (`PassthroughBody` for single-agent tasks, `VENBody` for the swarm).
